...
/// miscomp-issue command line interface (CLI)
#[derive(Parser, Debug)]
...
struct Cli {
    ...
    #[clap(long, env = "MISCOMP_ISSUE_LOG_DIR", value_names = &["DIR"], default_value = "{cache}/log")]
    pub log_dir: Option<PathBuf>,

    /// Log file rotation rolling frequency
    #[clap(
        long,
        env="MISCOMP_ISSUE_LOG_ROTATION",
        default_value = "daily",
    ...
    #[clap(long, env = "MISCOMP_ISSUE_LANG", default_value = "")]
    pub lang: zng::l10n::Langs,

    /// Localization files dir.
    #[clap(long, env = "MISCOMP_ISSUE_LANG_DIR", value_names = &["DIR"], default_value = "{res}/l10n")]
...
fn run() {
    ...
    shared::env::init_args(shared::env::MiscompIssueArgs {
        paths: cli.paths,
        log_dir,
